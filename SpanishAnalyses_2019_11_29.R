setwd("C:/Users/s1552951/Dropbox/R/EnglishCoordination/Spanish")
#setwd("/home/anita/Dropbox/R/EnglishCoordination/Spanish")
...
condition_entrain_singularfit <- glmer(aligncode ~ CenPartner*CenSecond + (1 + CenPartner|target) + (1|ID), 
