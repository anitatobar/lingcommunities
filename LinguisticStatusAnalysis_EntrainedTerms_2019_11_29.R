...
alignbyitem2 <- entrain %>%
  ...
  dplyr::summarise(mean = mean(alignbyitem), 
                   ...
                   N = n(),
                   se = sd/sqrt(n()))
alignbyitem2[3,] =c("Pretest", 4, 6.06, 20, 1.32)
...
#We found strong evidence for a lexical entrainment effect but no evidence for an effect of partner's community on participants' tendency to entrain. 
